...
import cl from './_CollectionBigMini.module.scss'
...
const CollectionBigMini = ({collection, addedCollectionList, setAddedCollectionList, className, ...props}) => {
    return (
...
export default CollectionBigMini;