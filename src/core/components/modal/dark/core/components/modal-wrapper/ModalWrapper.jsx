...
const ModalWrapper = ({wrapperClassName, className, setIsVisible, title, titleClassName, crossClassName, children, ...props}) => {
    ...
    return (
        <div className={[cl.wrapper, wrapperClassName].join(" ")}>
